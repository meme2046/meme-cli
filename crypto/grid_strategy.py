...
def mysql_to_csv(
    ...
    # csv去重,保留最后加入的数据
    deduplicated(csv_path, d_column_name, "last")
...
def strategy_sync_open(engine: Engine, csv_path: str):
    ...
    row_count = mysql_to_csv(
        ...
        query,
        update_status=1,
        d_column_name="spot_client_order_id",
    )
